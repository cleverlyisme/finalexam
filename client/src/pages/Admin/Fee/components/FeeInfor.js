...
const FeeInfor = (props) => {
  ...
  return (
    <div className={props.className && props.className}>
      <Block title={feeTitle}>
        <div>
          <p>
            Mã học sinh:{" "}
            <Bold>{student?._id || "6650974e493467ce955f4edc"}</Bold>
          </p>
          <p>
            Họ và tên học sinh:{" "}
            <Bold>{student?.fullName || "Đinh Phương Quang"}</Bold>
          </p>
          <p>
          ...
          <p>
            Ngày tháng năm sinh:{" "}
            <Bold>{moment(student?.dateOfBirth).format("DD/MM/YYYY")}</Bold>
          </p>
          <p>
